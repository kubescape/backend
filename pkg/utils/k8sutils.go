...
import (
	...
	"github.com/kubescape/backend/pkg/types"
...
func ImageTagToImageInfo(imageTag string) (*types.ImageInfo, error) {
...
func LoadConfig(configPath string) (*types.ClusterConfig, error) {
	if configPath == "" {
